    ...
    public void findViewByIdandInitialization() {
        ...
        if (provider != null) {
            ...
            if (provider.getImg().equalsIgnoreCase("http"))
                ...
                Picasso.get().load(AccessDetails.serviceurl + "/storage/" + provider.getImg()).memoryPolicy(MemoryPolicy.NO_CACHE).placeholder(R.drawable.ic_dummy_user).error(R.drawable.ic_dummy_user).into(profile_Image);
        }
    }
