...
import com.diff.user.app.Helper.LocaleUtils;
...
public class DiffApplication extends Application {

    public static final String TAG = DiffApplication.class
            .getSimpleName();
    private static DiffApplication mInstance;
    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;

    public static synchronized DiffApplication getInstance() {
        return mInstance;
    }
...
//                "https://play.google.com/store/apps/details?id=com.limoncab.app");
//
