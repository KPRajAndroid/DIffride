...
import com.diff.user.app.Models.CouponHistoryData;
...
public class CouponHistory extends Fragment {
    ...
    public void getHistoryList() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(AccessDetails.serviceurl + URLHelper.GET_COUPON_HISTORY, new Response.Listener<JSONArray>() {
            @Override
